...
public class WelcomeScreen extends JPanel implements AnimatedScreen {
    ...
    public WelcomeScreen(MainFrame mainFrame) {
        ...
        // buttonArea holds whichever button set is currently showing
    ...
    // gets current RoundedButtons in buttonArea.
     ...
     * Package-visible (not private) so other screens in roombooking.view -
     * like LoginScreen - can also construct WelcomeScreen.RoundedButton
     * instances without duplicating this whole class.
     */
    enum ButtonStyle {
